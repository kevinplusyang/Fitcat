...
class planOverviewControllerViewController: UIViewController {
    ...
    func setUpView() {
        ...
        let finalGoalInPounds = (currentWeight.kilogramsToPounds().trim2Decimals()) - (goalWeight.kilogramsToPounds().trim2Decimals())
        let finalGoalWeightInKilos = (currentWeight.trim2Decimals()) - (goalWeight.trim2Decimals())
